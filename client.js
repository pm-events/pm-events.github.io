...
document.getElementById("twitteren").onclick = () => window.open("https://x.com/PokemonMasters");
document.getElementById("twitterjp").onclick = () => window.open("https://x.com/pokemas_game");
